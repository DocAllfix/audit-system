...
- La nomina del Responsabile Ambientale in data 02/03/2026 (documento 102) formalizza la responsabilita'.
...
- La nomina del Responsabile Ambientale in data 02/03/2026 formalizza la responsabilita'.

Regola operativa: il nome del documento (visura camerale, organigramma aziendale, nomina, analisi ambientale, autorizzazione, procedura, ecc.) e' gia' sufficiente per identificare l'evidenza. Aggiungere (documento N) e' ridondante e vietato.
