...
- La nomina del Responsabile della Sicurezza delle Informazioni in data 02/03/2026 (documento 102) formalizza la responsabilita'.
...
- La nomina del Responsabile della Sicurezza delle Informazioni in data 02/03/2026 formalizza la responsabilita'.

Regola operativa: il nome del documento (visura camerale, organigramma aziendale, nomina, policy, procedura, registro asset, ecc.) e' gia' sufficiente per identificare l'evidenza. Aggiungere (documento N) e' ridondante e vietato.
